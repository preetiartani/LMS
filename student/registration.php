...
<?php
    if(isset($_POST["submit1"])){
        ...
        $query = "insert into student_registration (id,firstname,lastname,username,password,email,contact,sem,enrollment,status) values('','$_POST[firstname]','$_POST[lastname]','$_POST[username]','$_POST[password]','$_POST[email]','$_POST[contact]','$_POST[sem]','$_POST[enrollmentno]','no')";
